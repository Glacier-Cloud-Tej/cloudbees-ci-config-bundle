...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/Glacier-Cloud-Tej/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>Glacier-Cloud-Tej</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>Glacier-Cloud-Tej</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/Glacier-Cloud-Tej/pipeline-template-catalog.git</repositoryUrl>
              <traits>
